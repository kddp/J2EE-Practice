...
public String validate()
{
	...
	{
		mssg="name should not be null </br>";
	}
	if(email==null || !vailidateemail(email))
	{
		mssg+="email should have @ symbol and can have comma seperated email id</br>";
	}
	if(phone==null || phone.trim().equals("")|| !validateInt(phone))
	{
		mssg+="phone number should not be null, it should have digit only and could have coma seperated ph </br>";
	}
	if(dob==null || dob.trim().equals("")|| !validateDate(dob))
	{
		mssg+="dob should not be null and it should be in(dd/MM/YYYY) format</br> ";
	}
	if(tag==null || tag.trim().equals(""))
	{
		mssg+="tag should not be null and it could be comma separated </br>";
	}
	if(sex==null || sex.trim().equals(""))
	{
		mssg+="sex should not be null </br>";
	}
	if(mssg.equals(""))
	{
